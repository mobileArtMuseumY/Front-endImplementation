<template>
  <div class="container">
          ...
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                ...
                :key="index"
              >{{ skill.skillName }}</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
        <div class="sort">
    ...
    <div class="main">
      <project-item :projectItems="projectItem" v-for="(projectItem, index) in items" :key="index"></project-item>
    </div>
